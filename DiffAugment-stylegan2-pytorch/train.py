...
def setup_training_loop_kwargs(
    ...
    args.G_kwargs = dnnlib.EasyDict(class_name='training.networks.Generator', z_dim=z_dim, w_dim=latent_size, mapping_kwargs=dnnlib.EasyDict(text_kwargs = dnnlib.EasyDict(), layer_features=z_dim), synthesis_kwargs=dnnlib.EasyDict(block_kwargs=dnnlib.EasyDict()))
